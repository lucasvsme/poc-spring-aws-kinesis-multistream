...
@Configuration
public class EnrollmentStreamConfiguration {

    private static final String STREAM_ID = "EnrollmentStream";
    ...
    StreamProperties properties(Environment environment) {
        return new StreamProperties(
            ...
            new StreamProperties.Stream(environment.getRequiredProperty("streams.enrollment.name", String.class)),
            new StreamProperties.Application(environment.getRequiredProperty("streams.enrollment.application", String.class))
        );
    }
