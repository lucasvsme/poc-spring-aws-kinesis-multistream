...
@Configuration
public class StudentStreamConfiguration {

    private static final String STREAM_ID = "StudentStream";
    ...
    StreamProperties properties(Environment environment) {
        return new StreamProperties(
            ...
            new StreamProperties.Stream(environment.getRequiredProperty("streams.student.name", String.class)),
            new StreamProperties.Application(environment.getRequiredProperty("streams.student.application", String.class))
        );
    }
